...
// Update the path below to the correct relative path where PropertyListingProps is exported
import { PropertyListingProps } from "../../interfaces";
import FontAwesome from "@expo/vector-icons/FontAwesome";
// Update the import path and extension as needed based on your project structure
